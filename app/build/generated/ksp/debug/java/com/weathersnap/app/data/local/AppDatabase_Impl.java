  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `reports` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `cityName` TEXT NOT NULL, `temperature` REAL NOT NULL, `condition` TEXT NOT NULL, `humidity` INTEGER NOT NULL, `windSpeed` REAL NOT NULL, `pressure` REAL NOT NULL, `notes` TEXT NOT NULL, `imagePath` TEXT NOT NULL, `originalImageSizeBytes` INTEGER NOT NULL, `compressedImageSizeBytes` INTEGER NOT NULL, `timestamp` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ab907a643c6e62e85ff5aeae2221b9fa')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsReports.put("originalImageSizeBytes", new TableInfo.Column("originalImageSizeBytes", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsReports.put("compressedImageSizeBytes", new TableInfo.Column("compressedImageSizeBytes", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoReports.equals(_existingReports)) {
          return new RoomOpenHelper.ValidationResult(false, "reports(com.weathersnap.app.data.local.ReportEntity).\n"
                  + " Expected:\n" + _infoReports + "\n"
                  + " Found:\n" + _existingReports);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "ab907a643c6e62e85ff5aeae2221b9fa", "99a19d4ff2a3bd8702df9e20520fe7bc");
